...
<template>
    <div class="h-screen w-full flex flex-col">
        <div class="flex w-full h-full">
            <div
                class="w-2/5 hidden md:block h-full bg-blend-overlay bg-green-700 bg-[url('https://images.unsplash.com/photo-1533135091724-62cc5402aa20?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')]">
                <img src="https://images.unsplash.com/photo-1533135091724-62cc5402aa20?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    alt="" class="h-full hidden">
            </div>
            <div class="md:w-3/5 w-full flex flex-col h-max bg-white">
                ...
                <div class="w-full flex items-center justify-center my-auto h-full py-[20px]">
                    <div class="w-full">
                        ...
                        <form name="registrationForm" action="https://formspree.io/f/xdkojked" method="POST"
                            onSubmit="fbq('track','Lead')" data-netlify-honeypot="bot-field" data-netlify="true"
