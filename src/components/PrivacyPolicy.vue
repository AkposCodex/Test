<template>
    <div class="page text-start">
        <nav class="flex w-full lg:px-[60px] flex-col lg:items-center shadow-sm lg:flex-row">
            <nav class="w-full px-2 h-[60px] flex items-center justify-between">
            ...
            <div class="gap-4 items-start w-auto text-black hidden ">
                <RouterLink class=" text-black hover:font-bold  w-max" to="/">Home
                </RouterLink>
                <RouterLink class=" text-black hover:font-bold w-max" to="/about">About</RouterLink>
                <RouterLink to="/registration" class=" w-max text-black hover:font-bold" tabindex="0">Become an agent
                </RouterLink>
            </div>
        </nav>
        <div class="translations-content-container mt-12 lg:px-12 px-6">
            <div class="container">
                <div class="tab-content translations-content-item en visible" id="en">
                    ...
                    <ul class="list-disc pl-5 flex flex-col gap-4">
                        ...
                        <li>
                            <p><strong>Application</strong> refers to xPensPay, the software program provided by the
                                Company.</p>
                        </li>
                        <li>
                            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                                &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Simplex Business
                                Solutions, 28, Gbolade Adebanjo Street.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Device</strong> means any device that can access the Service such as a computer,
                                a cell phone or a digital tablet.</p>
                        </li>
                        <li>
                    ...
                    <br>
                    <h3 class="text-xl font-bold">Use of Your Personal Data</h3>
                    <br>
                    ...
                    <br>
                    <h3 class="text-xl font-bold">Retention of Your Personal Data</h3>
                    <br>
                    ...
                    <p>Your information, including Personal Data, is processed at the Company's operating offices and in
                        ...
                        from those from Your jurisdiction.</p>
                    <br>
                    ...
                    <ul class="list-disc pl-5 flex flex-col gap-4">
                        <li>By email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                data-cfemail="d3babdb5bc93a0babea3bfb6aba0aaa0a7b6befdb0bcbe">info@simplexsystem.com</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="footer mt-20">
            <div class="container">
                <p>Generated using <a href="https://www.termsfeed.com/privacy-policy-generator/"
