<template>
  <section class="flex flex-col justify-center self-stretch px-16 w-full bg-neutral-100 max-md:px-5 max-md:max-w-full">
...
const handleDownloadButtonClick = () => {
  ...
  // If you wanted to prevent default navigation (e.g., conditionally), you'd do:
  // event.preventDefault();
  logEvent(analytics, 'mobileapp_download_click', {
    platform: 'Android'
  })
};
</script>
